...
#temp_folder = Path('E:\\Data\\temp_for_sort')

#analysis_my_files(temp_folder)
thread = Thread(target=analysis_my_files, args=(temp_folder, ))
thread.start()
print('Start analysis_my_files')


#print(list_file)
#print(list_extensions)
#print(list_unknown_extensions)

#move_my_files(temp_folder)
thread = Thread(target=move_my_files, args=(temp_folder, ))
thread.start()
print('Start move_my_files')

#remove_empty_dirs(temp_folder)
thread = Thread(target=remove_empty_dirs, args=(temp_folder, ))
thread.start()
print('Start remove_empty_dirs')
